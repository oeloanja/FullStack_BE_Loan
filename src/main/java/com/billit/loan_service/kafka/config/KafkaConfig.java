...
public class KafkaConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, LoanStatusUpdateEvent>
    loanStatusUpdateEventKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, LoanStatusUpdateEvent> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(loanStatusUpdateEventConsumerFactory());
